-- ----------------------------------------------------------- --
-- Добавление завершённой сессии выгрузки контейнера с данными --
-- ----------------------------------------------------------- --
...
-- ----------------------------------------------- --
-- Добавление сессий выгрузки контейнера с данными --
-- ----------------------------------------------- --
INSERT INTO "upload_sessions" ("id", "state", "sha256", "size", "chunk_count", "chunk_size", "last_chunk_size") OVERRIDING SYSTEM VALUE
VALUES
(4, 'UPLOAD', '2350b3ccbac695c62f55787f54fb60e838c8f4767afe4d5a577ecb96a1ec19c0', 214, 7, 32, 22),
...
INSERT INTO "upload_chunks" ("upload_session_id", "chunk_id", "number", "user_uuid", "state", "last_modified")
VALUES
(7, 61, 1, '596aeb50-27a7-4361-ab12-e28ac6a4760c', 'PROCESSING', '2024-07-04T17:06:20.038187300'),
(7, 62, 2, '596aeb50-27a7-4361-ab12-e28ac6a4760c', 'PROCESSING', '2024-07-04T17:06:20.039189200'),
(7, 63, 3, '596aeb50-27a7-4361-ab12-e28ac6a4760c', 'UPLOAD',     '2024-07-04T17:06:20.039189200');
